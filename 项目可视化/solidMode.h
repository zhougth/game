...
private:
	...
	int A6[10][2] = { 7,9,7,8,6,8,6,7,6,6,5,6,4,6,3,6,3,5,3,4 };
	int relativeB6[10][2] = { 6,4,6,4,7,3,7,3,6,4,7,5,8,6,8,6,8,8,7,9 };
	int realB6[10][2] = { 6,4,6,3,6,2,6,1,5,1,5,2,5,3,4,3,4,4,3,4 };
public:
